PYTORCH_CKPT_MAPPING = {
    "text_encoder": [
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.0.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.0.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.0.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.1.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.1.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.1.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.2.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.2.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.2.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.3.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.3.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.3.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.4.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.4.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.4.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.5.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.5.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.5.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.6.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.6.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.6.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.7.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.7.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.7.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.8.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.8.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.8.mlp.fc2.bias", None),
        (
        ...
        ("cond_stage_model.transformer.text_model.encoder.layers.9.mlp.fc1.bias", None),
        (
            "cond_stage_model.transformer.text_model.encoder.layers.9.mlp.fc2.weight",
            (1, 0),
        ),
        ("cond_stage_model.transformer.text_model.encoder.layers.9.mlp.fc2.bias", None),
        (
    ...
    "diffusion_model": [
        ("model.diffusion_model.time_embed.0.weight", (1, 0)),
    ...
    "decoder": [
        ("first_stage_model.post_quant_conv.weight", (2, 3, 1, 0)),
    ...
    "encoder": [
        ("first_stage_model.encoder.conv_in.weight", (2, 3, 1, 0)),
        ...
        ("first_stage_model.encoder.down.1.block.0.nin_shortcut.weight", (2, 3, 1, 0)),
        ...
        ("first_stage_model.encoder.down.2.block.0.nin_shortcut.weight", (2, 3, 1, 0)),
